...
This search focused on recent representative work in GNSS, urban navigation, multipath/NLOS mitigation, robust positioning, and LEO PNT. Official PolyU and lab publication pages were used as identity checks for the selected author and paper list: <https://www.polyu.edu.hk/aae/people/academic-staff/dr-xu-bing/> and <https://pbingxu.github.io/publications/>.
